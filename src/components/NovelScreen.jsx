...
export default function NovelScreen({ stage, onChoiceSelected, onComplete }) {
  ...
  const introDialogues = [
    {
      speaker: '運命の観測者 ルナ',
      text: '魂の共鳴を確認しました。ようこそ、旅人よ。私はこの世界の星盤を観測する者、「ルナ」です。これより、あなたの「精神的属性診断」を開始します。'
    },
    {
      speaker: '運命の観測者 ルナ',
      text: 'これから、あなたには3つの試練の迷宮ゲートを攻略していただきます。あなたの移動速度、迷い、時の巻き戻し（Undo）、そして選択肢の一つ一つがリアルタイムで精神的エレメントの値としてスコア化されます。'
    },
    {
      speaker: '運命の観測者 ルナ',
  ...
  const outroDialogues = [
    ...
    {
      speaker: '運命の観測者 ルナ',
      text: '精神的エレメントを判定する前に、最後の質問です。迷宮を攻略している最中、あなたはどのような瞬間に充実感を覚えましたか？',
      choices: [
        {
    ...
    {
      speaker: '運命の観測者 ルナ',
      text: 'ありがとうございます。自己申告データと行動ログの突き合わせが完了しました。それでは、あなたの精神的エレメントを精神的エレメント方位盤に描きます。運命をご覧ください。'
    }
  ];
